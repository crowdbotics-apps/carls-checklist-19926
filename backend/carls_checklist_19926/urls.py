"""carls_checklist_19926 URL Configuration
...
admin.site.site_header = "Carls Checklist"
admin.site.site_title = "Carls Checklist Admin Portal"
admin.site.index_title = "Carls Checklist Admin"

# swagger
api_info = openapi.Info(
    title="Carls Checklist API",
    default_version="v1",
    description="API documentation for Carls Checklist App",
)
